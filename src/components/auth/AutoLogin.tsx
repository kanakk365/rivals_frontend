...
export default function AutoLogin({ children }: AutoLoginProps) {
    ...
    const [loginStatus, setLoginStatus] = useState<"checking" | "logging-in" | "success" | "error">("checking");
                ...
                >
                    ...
                    >
                        <motion.div
                            ...
                            initial={{ width: "0%" }}
                            animate={{
                                width: loginStatus === "success" ? "100%" :
                                    loginStatus === "error" ? "100%" :
                                        loginStatus === "logging-in" ? "70%" : "30%"
                            }}
                            transition={{
                                duration: loginStatus === "success" || loginStatus === "error" ? 0.3 : 2,
                                ease: "easeInOut"
                            }}
                        />
                    </motion.div>
