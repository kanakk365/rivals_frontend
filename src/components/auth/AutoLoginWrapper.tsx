...
export default function AutoLoginWrapper({ children }: AutoLoginWrapperProps) {
  ...
  if (loginStatus === "error") {
    return (
      <div
        className="flex h-screen w-full items-center justify-center bg-[#09090b] bg-gradient-to-br from-zinc-950 via-purple-950/20 to-zinc-950"
...
function LoadingScreen({ status }: { status: LoginStatus }) {
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-[#09090b] bg-gradient-to-br from-zinc-950 via-purple-950/20 to-zinc-950"
      style={{ backgroundColor: "#09090b" }}
    >
