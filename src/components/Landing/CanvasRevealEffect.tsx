...
const ShaderMaterial = ({
  ...
  const getUniforms = useMemo(() => {
    return () => {
      const preparedUniforms: Record<string, { value: number | THREE.Vector2 | THREE.Vector3 | THREE.Vector3[] | number[]; type?: string }> = {}
      ...
      switch (uniform.type) {
        case "uniform1f":
          ...
          break
        case "uniform3f":
          if (Array.isArray(uniform.value) && uniform.value.length === 3 && typeof uniform.value[0] === "number") {
        ...
        case "uniform3fv":
          ...
          break
        case "uniform2f":
          if (Array.isArray(uniform.value) && uniform.value.length === 2 && typeof uniform.value[0] === "number") {
            preparedUniforms[uniformName] = {
